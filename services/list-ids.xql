...
(: Need to check ids in github and cross check. ugh
declare function local:check-github-ids(){
...
xmldb:store('/db/apps/tei-editor/services','syr-ids.xml', local:check-db-ids()))
